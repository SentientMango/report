...
%\begin{figure}
%\centering
%	\includegraphics[width=\linewidth]{default_xsecs.png}
%	\caption{(a) $ZZ\rightarrow ee$ cross section \hspace{5 cm} (b) $Z(\rightarrow ee)+\gamma$ cross section\\Cross sections of $ZZ$ and $Z+\gamma$ processes with the cuts as in Table 1.}
%\end{figure}
...
\centering
	...
	\begin{subfigure}{0.49\textwidth}
		...
		%\caption{$R$ curve from $q\bar{q}$ and $qg$ subprocesses}
	\end{subfigure}	
