...
\centering
	...
	\caption{$R$ curve plotting as a function of $p_T$, showing the uncertainty due to variation of photon isolation parameters $\epsilon_h$ and $n$ in the smooth cone isolation procedure (Frixione) and $\epsilon_h$ in the photon isolation procedure.}
...
\end{split}
\end{equation}
An uncertainty less than 4\% is observed over the full range, and $< 2\%$ around $R = 0.42$ at $p_T = 100$ GeV. 
